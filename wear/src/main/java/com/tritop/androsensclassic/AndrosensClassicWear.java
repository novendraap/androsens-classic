...
public class AndrosensClassicWear extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.tritop.androsensclassic.R.layout.activity_androsens_classic_wear);
        mSensorManager = (SensorManager) getSystemService(Context.SENSOR_SERVICE);
        getAvailableSensors();
        mListAdapter = new SimpleAdapter(this, itemList, R.layout.list_item_layout, boundRows, boundViews);
        final WatchViewStub stub = (WatchViewStub) findViewById(com.tritop.androsensclassic.R.id.watch_view_stub);
